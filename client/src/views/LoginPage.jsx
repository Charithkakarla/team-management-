// Login page: handles sign-in and account creation.
// It switches between login and register views on the same screen.
// Use this file to understand the authentication page.
