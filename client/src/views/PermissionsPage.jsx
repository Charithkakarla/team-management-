// Permissions page: looks up effective access for a user in a team.
// It helps the CEO inspect what a user can do inside one team.
// Use this file to understand permission resolution.
            ...
            {loading ? (
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {permissions.map((permission) => (
                  <div key={permission} className="rounded-2xl border border-border bg-surface p-4 shadow-soft">
                    <div className="text-sm font-semibold text-text-primary">{permission}</div>
                    <div className="mt-1 text-xs text-text-muted">Granted for the selected user and team.</div>
                  </div>
                ))}
              </div>
            ) : (
