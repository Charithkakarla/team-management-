// Membership API: manages team membership and role assignments.
// It handles team membership CRUD and role updates.
// Use this file for team member actions in the UI.
import { api } from './api';
...
export const fetchTeamMembers = (teamId) => api.get(`/memberships/team/${teamId}`);
