import { Users, FolderKanban, ShieldCheck, KeyRound } from 'lucide-react';
...
export const DashboardPage = () => {
  const { users, teams, roles, loading } = useData();
  ...
  const stats = [
    ...
    { label: 'Roles', value: roles.length, helper: 'Role templates with permissions', icon: <ShieldCheck className="h-5 w-5" /> },
    { label: 'Permission rules', value: '5', helper: 'Dynamic access controls', icon: <KeyRound className="h-5 w-5" /> }
  ];
